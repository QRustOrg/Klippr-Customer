            ...
            LaunchedEffect(redemptionState.generated) {
                redemptionState.generated?.let { code ->
                    ...
                    notificationViewModel.notify(
                        type = com.example.klippr.notification.domain.model.NotificationType.REDEMPTION_GENERATED,
            ...
            PromotionDetailScreen(
                ...
                onToggleFavorite = { id, isFavorite ->
                    if (isFavorite) {
                        ...
                        notificationViewModel.notify(
                            type = com.example.klippr.notification.domain.model.NotificationType.FAVORITE_ADDED,
            ...
            NotificationScreen(
                ...
                onNotificationClick = { notif ->
                    notif.relatedId?.let { id ->
                        navController.navigate(Routes.qrCode(id))
                    }
                },
            )
        }
